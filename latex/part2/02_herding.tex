...
\paragraph{Summary of contributions} The results presented in this chapter are joint work with David Duvenaud and have been published \citep{huszar2012herdingbmcuai}. The authors contributed equally to designing research and interpreting results. The theoretical analysis of approximate submodularity is original contribution by FH. The method was implemented and experiments were carried out by DD. Establishing connections to loss-calibrated appriximate inference and scoring rules framework is original contribution by FH.
