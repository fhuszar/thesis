...
\expectargs{\gp}{Z} & = \expectargs{\gp}{\int f(\vx)p(\vx)d\vx}\\
 & = \intRasmussen2006Rasmussen2006Rasmussen2006 \intRasmussen2006Rasmussen2006 f(\vx) p(f(\vx)|\vf(\vX)) p(\vx) d\vx df\\
 & = \intRasmussen2006Rasmussen2006Rasmussen2006 \mf(\vx) p(\vx) d\vx \\
 & = \left[ \intRasmussen2006Rasmussen2006 k(\vx, \vX) p(\vx) d\vx \right] K^{-1} \vf(\vX) \\
 & = \vz^T K^{-1} \vf(\vX)
\label{eq:marg_mean_symbolic}
\end{align} 
where
\begin{align}
z_n & = \intRasmussen2006Rasmussen2006 k(\vx, \vx_n) p(\vx) d\vx = \expectargs{\vx' \sim p}{k(\vx_n, \vx')}.
\end{align}
%
...
%\nonumber & = \int \Bigg( Rasmussen2006Rasmussen2006 \left( \int f(\vx) p(\vx) d\vx - \int \mf(\vx') p(\vx') d\vx' \right) \\ 
%\nonumber & \quad \times \left( \int f(\vx) p(\vx) d\vx - \int \mf(\vx') p(\vx') d\vx' \right) Rasmussen2006Rasmussen2006 \Bigg) p(f) df \\ 
%\nonumber & = \intRasmussen2006Rasmussen2006Rasmussen2006 \intRasmussen2006Rasmussen2006 \intRasmussen2006Rasmussen2006 \left[ f(\vx) - \mf(\vx) \right] \left[ f((\vx') - \mf(\vx') \right] p(f) df \\
%\nonumber & \qquad \times   p(\vx) p(\vx') d\vx d\vx' \\
%\nonumber & = \intRasmussen2006Rasmussen2006 Rasmussen2006\intRasmussen2006Rasmussen2006 \Cov \left[ f((\vx), f((\vx') \right] p(\vx) p(\vx') d\vx d\vx' \\
%\nonumber & = \intRasmussen2006Rasmussen2006Rasmussen2006 \intRasmussen2006Rasmussen2006 \left[ k(\vx, \vx') - k(\vx, \vX) K^{-1} k(\vX, \vx') \right] \\
%\nonumber          & \qquad \times p(\vx) p(\vx') d\vx d\vx' \\ 
%\nonumber & = \intRasmussen2006Rasmussen2006Rasmussen2006 \intRasmussen2006Rasmussen2006 k(\vx, \vx') p(\vx) p(\vx') d\vx d\vx' \\
%\nonumber & \quad - \left[ \intRasmussen2006Rasmussen2006 k(\vx, \vX) p(\vx) d\vx \right] K^{-1} \left[ \intRasmussen2006Rasmussen2006 k(\vX, \vx') p(\vx') d\vx' \right] \\
