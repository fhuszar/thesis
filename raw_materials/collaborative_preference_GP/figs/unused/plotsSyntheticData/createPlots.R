...
for (i in 0 : nExperiments) {
	for (j in 1 : nRepetitions) {
		errorGPCbald[ j, i + 1 ] <- read.table(paste("/home/miguel/projects/multiTaskPreferenceLearning/multiTaskPreferenceLearning",
			"/activeLearningNewVersion/syntheticData15itemsFinal/epGPCbald/simulation", j, "/results/error", i, ".txt", sep = ""))$V1
		errorGPCentropy[ j, i + 1 ] <- read.table(paste("/home/miguel/projects/multiTaskPreferenceLearning/multiTaskPreferenceLearning",
			"/activeLearningNewVersion/syntheticData15itemsFinal/epGPCentropy/simulation", j, "/results/error", i, ".txt", sep = ""))$V1
		errorGPCrandom[ j, i + 1 ] <- read.table(paste("/home/miguel/projects/multiTaskPreferenceLearning/multiTaskPreferenceLearning",
			"/activeLearningNewVersion/syntheticData15itemsFinal/epGPCrandom/simulation", j, "/results/error", i, ".txt", sep = ""))$V1
...
for (i in 0 : nExperiments) {
	for (j in 1 : nRepetitions) {
		errorMPLbald[ j, i + 1 ] <- read.table(paste("/home/miguel/projects/multiTaskPreferenceLearning/multiTaskPreferenceLearning",
			"/activeLearningNewVersion/syntheticData15itemsFinal/epMPLbald/simulation", j, "/results/error", i, ".txt", sep = ""))$V1
		errorMPLentropy[ j, i + 1 ] <- read.table(paste("/home/miguel/projects/multiTaskPreferenceLearning/multiTaskPreferenceLearning",
			"/activeLearningNewVersion/syntheticData15itemsFinal/epMPLentropy/simulation", j, "/results/error", i, ".txt", sep = ""))$V1
		errorMPLrandom[ j, i + 1 ] <- read.table(paste("/home/miguel/projects/multiTaskPreferenceLearning/multiTaskPreferenceLearning",
			"/activeLearningNewVersion/syntheticData15itemsFinal/epMPLrandom/simulation", j, "/results/error", i, ".txt", sep = ""))$V1
	}
}
...
for (i in 0 : nExperiments) {
	for (j in 1 : nRepetitions) {
		errorMPLbaldBirlutiu[ j, i + 1 ] <- read.table(paste("/home/miguel/projects/multiTaskPreferenceLearning/multiTaskPreferenceLearning",
			"/activeLearningNewVersion/syntheticData15itemsFinal/epMPLbaldBirlutiu/simulation", j, "/results/error", i, ".txt", sep = ""))$V1
		errorMPLentropyBirlutiu[ j, i + 1 ] <- read.table(paste("/home/miguel/projects/multiTaskPreferenceLearning/multiTaskPreferenceLearning",
			"/activeLearningNewVersion/syntheticData15itemsFinal/epMPLentropyBirlutiu/simulation", j, "/results/error", i, ".txt", sep = ""))$V1
		errorMPLrandomBirlutiu[ j, i + 1 ] <- read.table(paste("/home/miguel/projects/multiTaskPreferenceLearning/multiTaskPreferenceLearning",
			"/activeLearningNewVersion/syntheticData15itemsFinal/epMPLrandomBirlutiu/simulation", j, "/results/error", i, ".txt", sep = ""))$V1
	}
}

# We plot the data

pdf("plotSyntheticDatasetSTvsMT.pdf", width = 7.5, height = 7.5)
par(cex = 1.3)
plot(seq(0, 10), apply(errorGPCbald, 2, mean), lwd = 3, lty = 1, col = "black", type = "l",
	main = "Synthetic Dataset. MT vs. ST", xlab = "Number of Active Measurements", ylab = "Average Test Error", ylim = c(0.144, 0.235))
...
pdf("plotSyntheticDatasetMBvsMT.pdf", width = 7.5, height = 7.5)
par(cex = 1.3)
plot(seq(0, 10), apply(errorMPLbaldBirlutiu, 2, mean), lwd = 3, lty = 1, col = "black", type = "l",
	main = "Synthetic Dataset. MT vs. MB", xlab = "Number of Active Measurements", ylab = "Average Test Error", ylim = c(0.144, 0.24))
